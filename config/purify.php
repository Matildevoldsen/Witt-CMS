    ...
    */
    ...
    'configs' => [
        ...
        'tiptap' => [
            ...
            'AutoFormat.AutoParagraph' => false,
            'AutoFormat.RemoveEmpty' => false,
            'HTML.Allowed' => 'strike,b,strong,i,em,u,a[href|title|target],p[style|class],span[style|class],div[style|class],br,ul,ol,li,img[src|alt|width|height],blockquote,cite,code'
        ]
